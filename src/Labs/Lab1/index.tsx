        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Marinate the chicken with soy sauce and Shaoxing wine first to infuse the flavor.</li>
                    <li>Coat the chicken with a dry coating: a mixture of cayenne pepper powder and ground Sichuan
                        peppercorns along with cornstarch.
                    </li>
                    <li>Spread out the chicken in the hot pan and fry it with minimal touching to ensure browning.</li>
                    <li>Once the chicken is browned on both sides and cooked through, transfer it onto a plate.</li>
                    <li>Stir fry the aromatics.</li>
                    <li>Roast the dry spices and chili peppers to release the fragrance.</li>
                    <li>Add the chicken back to the pan and toss it.</li>
                    <li>Stir in the cilantro.</li>
                    <li>Serve a bowl of steamed rice, another cold appetizer or a light vegetable dish with Diced
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Harry Potter Novel series</li>
                    <li>Expresses in the Palace</li>
                    <li>Nirvana In Fire</li>
                </ul>
            </div>
