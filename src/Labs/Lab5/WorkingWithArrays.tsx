    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <div className="d-flex align-items-center">
                <input value={todo.id} className="form-control w-25 me-2"
                       onChange={(e) => setTodo({...todo, id: e.target.value})}/>
                <input value={todo.title} className="form-control w-50 me-2"
                       onChange={(e) => setTodo({...todo, title: e.target.value})}/>
                <br/><br/><hr/>
                <a href={`${API}/${todo.id}/title/${todo.title}`} className="btn btn-primary ms-auto">
                    Update Todo
                </a>
            </div>
            <hr/>
            ...
            <div className="d-flex align-items-center">
                <input value={todo.id} className="form-control w-25 me-2"
                       onChange={(e) => setTodo({...todo, id: e.target.value})}/>
                <input value={todo.description} className="form-control w-50 me-2"
